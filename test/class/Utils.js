import {dataMortaiseTibia,dataImplantTibia,dataMortaiseTalaire,dataImplantTalaire,dataTalaire,patient,admin} from './objectDeclaration.js';
...
export default class Utils {
    ...
    configVisualisationPage() {
        if(dataResponse.User.profil === 'administrator' || dataResponse.Planning.state === 2){
            /**
    ...
    configButtonVisualisation(){
        ...
        side === 'Gauche' ? $('#removeVarusValgusTi').html(varus) : $('#removeVarusValgusTi').html(valgus);
        side === 'Gauche' ? $('#addVarusValgusTi').html(valgus) : $('#addVarusValgusTi').html(varus);
        ...
        side === 'Gauche' ? $('#addVarusValgusTa').html(varus) : $('#addVarusValgusTa').html(valgus);
        side === 'Gauche' ? $('#removeVarusValgusTa').html(valgus) : $('#removeVarusValgusTa').html(varus);
