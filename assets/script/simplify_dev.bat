...
C:
cd C:\wamp\www\gestion_in2bones\web\
...
@set mlxScriptFile= C:\wamp\www\gestion_in2bones\web\3din2_gestion\assets\script\quadric.mlx
@set mlxScriptFileClean= C:\wamp\www\gestion_in2bones\web\3din2_gestion\assets\script\quadricNoS.mlx
...
@set meshlabserverPath="C:\Program Files\VCG\MeshLabv2\meshlabserver.exe"
