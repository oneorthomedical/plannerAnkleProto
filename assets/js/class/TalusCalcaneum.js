...
import {dataMortaiseTalaire, dataMortaiseTibia, mortaiseTalaire} from "./objectDeclaration";
import {pathToLink,epaisseur} from "./Version";
import {labelEpaisseur} from "./Utils";

export default class TalusCalcaneum {
    get change() {
        return this._change;
    }
