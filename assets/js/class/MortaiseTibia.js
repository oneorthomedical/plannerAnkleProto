...
import {browser} from "./Version";

import {pathToLink,heightTibia,widthTibia} from "./Version";
import {dataImplantTalaire} from "./objectDeclaration";

export class MortaiseTibia {
    ...
    /*  /!*  let css = browser!== 'firefox' ? `zoom : 150%` : `100%`;*!/
        ...
        if(value <11) {
            $.notify(
                " Attention en médialisant la coupe tibiale, le risque de fragilisation de la malléole interne est plus élevé ",
            {
                position : "top center",
                style : 'happyblue'
            });
